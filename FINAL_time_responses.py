...
class RealTimePlot:
    def __init__(self, tracker1, tracker2, x1, x2, x_ea):
        ...
        # Time domain plots for h and alpha
    ...
    def init_plot(self):
        ...
        return self.line_h, self.line_alpha
    ...
    def run(self):
        ani = animation.FuncAnimation(self.fig, self.update_plot, init_func=self.init_plot, interval=100, save_count=100)
        plt.show()
...
if __name__ == "__main__":
    ...
    Plan = False  # Set to False if want to switch the assignment
    if Plan:
